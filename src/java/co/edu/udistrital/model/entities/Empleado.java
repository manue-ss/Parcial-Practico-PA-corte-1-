...
public class Empleado extends Cuenta {
    ...
    /**
     * Constructor por defecto. Inicializa todos los atributos propios y
     * heredados con cadenas vacías para evitar errores de puntero nulo
     * (NullPointerException) durante el flujo de datos en la interfaz de
     * usuario.
     */
    public Empleado() {
        // Inicializa id, nombreUsuario, contrasenia, nombreCompleto, correo y telefono
        super("", "", "", "", "", "");
        this.dni = "";
        this.direccion = "";
        this.cargo = "";
