...
<html lang="es">
    <head>
        <title>Gestión de Empleados - RentZone Staff</title>
        <meta charset="UTF-8" />
    ...
    <body>
        <header class="header">
            ...
            <div class="header-title">
                <span class="admin-panel-title">Panel de Administrador</span>
            </div>
        ...
        <main class="main">
            ...
            <div class="dashboard-content">
                <div class="action-box">
                    <h2 class="action-box-title admin-action-title">
                        Alta de Nuevo Empleado
                    </h2>
                    <div class="admin-action-subtitle">
                        Esta sección es exclusiva para la creación de
                        credenciales de acceso para el personal interno.
                    </div>
                    ...
                    <form action="RegisterEmployeeServlet" method="POST">
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label for="cargo">Rol o Cargo Asignado</label>
                                <input
                                    type="text"
                                    id="cargo"
                                    name="cargo"
                                    placeholder="Ej. Vendedor, Soporte, Admin"
                                    required />
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label for="nombreUsuario"
                                    >Usuario de Acceso en Sistema</label
                                >
                                <input
                                    type="text"
                                    id="nombreUsuario"
                        ...
                        <div class="form-group">
                            <label for="nombreCompleto"
                                >Nombre Completo del Empleado</label
                            >
                            <input
                                type="text"
                                id="nombreCompleto"
                        ...
                        <div class="form-group">
                            <label for="direccion"
                                >Dirección Residencial Física</label
                            >
                            <input
                                type="text"
                                id="direccion"
                        ...
                        <button type="submit" class="btn-primary admin-btn">
