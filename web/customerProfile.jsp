...
<%@ page import="co.edu.udistrital.model.dto.ClienteDTO" %>
<%@ page import="co.edu.udistrital.model.enums.TipoMembresia" %>
<!doctype html>
<html lang="es">
    <head>
    ...
    <body>
        ...
        <main class="main">
            ...
            <div class="page-content profile-page-content">
                <%
                    ClienteDTO c = (ClienteDTO) session.getAttribute("usuarioLogueado");
                    if (c == null) {
                    ...
                    <form action="UpdateMembershipServlet" method="POST">
                        <div class="form-group">
                            ...
                            <select id="tipoMembresia" name="membresia">
                                ...
                                <option value="<%= tipo.name()%>" <%= (c.getMembresiaSeleccionada() == tipo.name()) ? "selected" : ""%>>
                                    <%= tipo.name()%>
                                </option>
                                <% }%>
                            </select>
